...
# Milestone 4 - The pointwise one-dimensional Energy Balance Model

## The pointwise one-dimensional Energy Balance Model
...
In the previous milestone you have implemented the one-dimensional EBM for the global mean temperature. In this milestone you will use this model to compute the mean temperature for the northern and southern hemisphere. Furthermore you will implement the EBM model pointwise for each grid point.
