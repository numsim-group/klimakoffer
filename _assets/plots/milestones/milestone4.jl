...
function plot_annual_temperature_north_south(annual_temperature_north,
    ...
    #savefig(p, "annual_temp_north_south.png")
    #display(p)
    return p
end
...
function milestone4()
    ...
    savefig(plot_annual_temperature_north_south(annual_temperature_north_,
        ...
        "annual_temp_north_south_means.png")
    ...
    savefig(plot_annual_temperature_north_south(annual_mean_temperature_north,
                                        annual_mean_temperature_south,
                                        annual_mean_temperature_total,
                                        average_temperature_north_,
                                        average_temperature_south_,
                                        average_temperature_total_),
                                        "annual_temp_north_south_pointwise.png")
    ...
    savefig(plot_annual_temperature(annual_temperature_cologne, average_temperature_cologne,
                            "Annual temperature with CO2 = $co2_ppm [ppm] in Cologne"),
                            "annual_temp_cologne.png")
    ...
    gif(anim, joinpath(@__DIR__, "annual_temperature_pointwise.gif"), fps=7)
end
