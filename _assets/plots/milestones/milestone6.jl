...
function milestone6()
    ...
    savefig(spy(jacobian[1:300, 1:300]), "jacobian.png")
    ...
    savefig(plot_temperature(temperature, geo_dat, 1),
    "temp_co2.png")
    ...
    savefig(plot_annual_temperature_north_south(annual_mean_temperature_north,
                                        ...
                                        "annual_temp_north_south_pointwise_co2.png")
