...
3. Write a function *calc\_radiative\_cooling\_co2*, which returns the $CO_2$ dependent radiative cooling $A$ for a given $CO_2$ concentration $c$. As default values use the $CO_2$ concentration of the year 1950, $c_0 = 315.0$ and the radiative cooling base $\beta = 210.3$ The radiative cooling $A$ is given by
\begin{align}
A (c) = \beta-5.35 \log\left(\frac{c}{c_0}\right)
\label{A}
\end{align}
