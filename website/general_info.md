...
* We have 6 pre-made milestones (sub-projects) with the following structure: 
  ...
  2. "Implementation phase": Hands-on programing in groups. We are here to help: can be used to sit together and work on the milestones, ask questions, discussions, etc.  
